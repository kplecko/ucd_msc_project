...
from sources import youtube_data_analysis_db_updater
...
def perform_database_update():
    try:
        ...
        try:
            data_update_ret = youtube_data_analysis_db_updater.db_update()
...
def database_update_scheduler_thread_main():
    ...
    config_name = "analysis_data_automatic_update_schedule"
